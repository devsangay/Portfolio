...
export default function Footer() {
    ...
    return (
        <section className="mt-4 sm:mt-16 border-t border-secondary py-4 sm:py-16">
            <div className="flex sm:items-center flex-wrap sm:justify-center sm:space-x-16">
                {
                    MENU_ITEMS.map((menu) => {
                        ...
                        return (
                            <>
                                {
                                    menu.id === 'cv' ? (
                                        <div className="flex space-x-2 items-center w-[33%] mt-[12px] sm:mt-0 sm:w-auto px-2 rounded-3xl text-lightGray text-[18px] cursor-pointer 
                                        ...
                                        <div className="flex space-x-2 items-center w-[33%] sm:w-auto px-2 rounded-3xl text-lightGray text-[18px] cursor-pointer 
                                            relative transition duration-300 after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[1px] after:bg-cyanTeal after:shadow-[0_0_8px_#22d3ee] after:transition-all after:duration-300 hover:after:w-full" 
                                            key={menu.id}
            ...
            <div className="flex justify-center space-x-16 mt-8 sm:mt-16">
                {
